...
describe('Card tests', () => {
  test('Should render a open card when "opened" prop is passed', () => {
    const { container } = render(<Card name="Drake Johnson" title="CEO" avatar={drake} quote="Test" opened />);
    expect(container.querySelector('input[type="checkbox"]')).toBeChecked();
  });

  test('Clicking open icon should open the card', () => {
    const { container } = render(<Card name="Drake Johnson" title="CEO" avatar={drake} quote="This is my quote" />);
